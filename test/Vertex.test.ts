...
describe('Vertex', () => {
    ...
    it('1) should calculate the bisector correctly', () => {
  ...
  it('2) should identify a reflex vertex', () => {
    const v1 = new Vector(0, 0)
    const v2 = new Vector(1, 0)
    const v3 = new Vector(1, -1)
    const vertex = new Vertex(v2)
  ...
  it('3) should calculate speed correctly', () => {
    const v1 = new Vector(0, 0)
    const v2 = new Vector(1, 0)
    const v3 = new Vector(1, 1)
    const vertex = new Vertex(v2)
  ...
  // it('4) should compute position at time correctly', () => {
  //   const v1 = new Vector(0, 0)
  //   const v2 = new Vector(1, 0)
  //   const v3 = new Vector(1, 1)
  //   const vertex = new Vertex(v2)
